  ...
  return (
    <header className="py-8 md:px-36 px-6">
      <div className=" flex justify-between  items-center m-auto text-secondary">
        <img src={Logo} alt="" />
        <ul
          className={` navbar active  md:flex hidden flex-col  gap-8 items-center `}
        >
          <li>Home</li>
          <li>About</li>
          <li>Tech Stack</li>
        ...
        <div
          className={`${
            toggle ? "hidden" : "flex"
          } p-12 absolute top-16 right-0 left-0  w-full`}
        >
          <ul
            className={` py-10 navbarActive  md:flex  flex-col  gap-10 items-center `}
          >
            <li>Home</li>
            <li>About</li>
            <li>Tech Stack</li>
